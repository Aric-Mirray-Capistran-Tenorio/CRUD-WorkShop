...
<body>
    ...
    <div class="container-lg mt-5">
        ...
        <h1 class="text-center bg-danger text-light ">LISTADO DE VENDEDORES</h1>
        <div class="table-responsive-sm">
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            <th scope="row"><?php echo $resultado['id_vendedor'] ?></th>
                            ...
                            <th scope="row">
                                <a href="<?php echo base_url; ?>Formularios/vendedores/actualizar.php?Id=<?php echo $resultado['id_vendedor'] ?>" class="btn btn-outline-warning">
                                    <i class="fa-solid fa-pen-to-square fa-beat"></i>
                                </a>
                                <a href="<?php echo base_url; ?>CRUDM/eliminarDatos.php?Id=<?php echo $resultado['id_vendedor'] ?>" class="btn btn-outline-danger">

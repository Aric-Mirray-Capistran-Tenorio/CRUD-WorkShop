        ...
        <div class="table-responsive-sm">
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    INNER JOIN taller ON productos.ubicacionId = taller.id_taller
                    INNER JOIN vendedores ON productos.vendedorId = vendedores.id_vendedor");
                    ...
                    ?>
                        <tr>
                            ...
                            <th scope="row"><?php echo $resultado['region'] ?></th>
                            <th scope="row"><?php echo $resultado['descripcion'] ?></th>
                            <th scope="row"><?php echo $resultado['ubicacionPro'] ?></th>
                            <th scope="row"><?php echo $resultado['vendedorId'] ?></th>
                            <th scope="row">
